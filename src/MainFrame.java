...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "New Student", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 3, 12))); // NOI18N
        jPanel2.setOpaque(false);

        jLabel2.setFont(new java.awt.Font("Comic Sans MS", 1, 12)); // NOI18N
        jLabel2.setText("Name");

        tfName.setFont(new java.awt.Font("Comic Sans MS", 0, 10)); // NOI18N
        ...
        tfMobile.setFont(new java.awt.Font("Comic Sans MS", 1, 10)); // NOI18N

        jLabel5.setFont(new java.awt.Font("Comic Sans MS", 1, 12)); // NOI18N
        jLabel5.setText("Address");

        tfAddress.setFont(new java.awt.Font("Comic Sans MS", 0, 10)); // NOI18N

        jLabel6.setFont(new java.awt.Font("Comic Sans MS", 1, 12)); // NOI18N
        jLabel6.setText("Branch");

        tfBranch.setFont(new java.awt.Font("Comic Sans MS", 0, 10)); // NOI18N
        ...
        tableClients.setFont(new java.awt.Font("Comic Sans MS", 1, 12)); // NOI18N
        tableClients.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Name", "Email", "Mobile", "Address", "Branch"
            }
        ));
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if (name.isEmpty() || email.isEmpty() || mobile.isEmpty() || address.isEmpty() || branch.isEmpty()) {
            ...
            model.addRow(new Object[] {name,email,mobile,address,branch});
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (row < 0) {
            JOptionPane.showMessageDialog(this,
                                "No row is selected! Please enter one row",
                                "select row",
                                JOptionPane.ERROR_MESSAGE);
        } else {
            DefaultTableModel model = (DefaultTableModel) tableClients.getModel();
